    ...
    public class JsonReader
    {
        ...
        public static JsonObject ParseObject(string json, ref bool success)
        {
            ...
            if (json != null)
            {
                ...
                int index = 0;
                var jo = ParseObject(charArray, ref index, ref success, true);
                if (!success)
                    return null;
        ...
        protected static JsonObject ParseObject(char[] json, ref int index, ref bool success, bool skipcurly = false)
        {
            ...
            while (!done)
            {
                ...
                if (token == JsonReader.TOKEN_NONE && skipcurly)
                    break;
                else if (token == JsonReader.TOKEN_NONE)
                {
                    success = false;
                    return null;
                }
