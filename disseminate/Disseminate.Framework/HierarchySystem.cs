...
namespace Disseminate
{
    ...
    //public class EntityComponentHierarchy
    //{
    //    public int id;
    //    public EntitySystemHierarchyNode parent;
    //    public List<EntitySystemHierarchyNode> children;

    //    public Position position;

    //    public bool change(EntityManager em)
    //    {
    //        position = em.get<Position>(id);
    ...
    //public abstract class EntitySystemHierarchyNode
    //{
    //    public int ID;
    ...
    ////public class EntityComponentHierarchy<T0> : EntityComponentHierarchy
    ////{

    ////}

    //public abstract class HierarchySystem
    //{
