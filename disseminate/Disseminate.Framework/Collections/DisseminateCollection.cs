...
// Disseminate Graphics Engine Library
// 
//
...
// <file>
//     <license see="http://Disseminate3d.net/wiki/index.php/license.txt"/>
//     <id value="$Id: DisseminateCollection.cs 2940 2012-01-05 12:25:58Z borrillis $"/>
// </file>
...
namespace Disseminate.Collections
{
    ...
    /// </summary>
    public class DisseminateCollection<T> : Dictionary<string, T>
    {
        #region Constants
        ...
        protected DisseminateCollection(Object parent)
        ...
        public DisseminateCollection(DisseminateCollection<int> copy)
        ...
        /// <summary>
        ///	Adds an unnamed object to the <see cref="DisseminateCollection{T}"/> and names it manually.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="DisseminateCollection{T}"/>.
        /// </summary>
        /// <returns>An <see cref="IEnumerator{T}"/> for the <see cref="DisseminateCollection{T}"/> values.</returns>
    ...
    ///	Serves as a basis for strongly typed collections in the engine.
    /// </summary>
    public class DisseminateSortedCollection<TKey, TValue> : SortedList<TKey, TValue>
    {
        #region Constants
        ...
        ///
        /// </summary>
        public DisseminateSortedCollection()
            : base(InitialCapacity)
        {
            this.parent = null;
        }
        ...
        /// </summary>
        /// <param name="parent"></param>
        public DisseminateSortedCollection(Object parent)
            : base(InitialCapacity)
        {
            this.parent = parent;
        }
        ...
        /// </exception>
        public DisseminateSortedCollection(int capacity, IComparer<TKey> comparer)
        ...
        /// </exception>
        public DisseminateSortedCollection(IDictionary<TKey, TValue> dictionary, IComparer<TKey> comparer)
