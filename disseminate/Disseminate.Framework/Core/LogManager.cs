...
namespace Disseminate.Core
{
    ...
    public sealed class LogManager : Singleton<LogManager>
    {
        ...
        /// </summary>
        private NamedCollection<Log> logList = new NamedCollection<Log>();
        ...
        public Log DefaultLog
        {
            get
            {
                if (defaultLog == null)
                {
                    throw ExceptionFactory.CreateFatalException("No logs have been created yet.");
                }
        ...
        public Log GetLog(string name)
        {
            ...
            {
                throw ExceptionFactory.CreateFatalException("Log with the name '{0}' not found.", name);
            }
