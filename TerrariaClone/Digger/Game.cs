...
using GameName1.Digger.Components;
...
namespace GameName1.Digger
{
    ...
    public class Game : GameEngine
    {
        ...
        protected override void LoadContent()
        {
            ...
            camera.transform2().Position = new Vector2(505, 500) * Settings.TileSizeV;

            //camera.createComponent<TerrainCollider>();
            camera.createScript<Camera>();


            var other = Root.instance.RootObject.createChild();
            var oc = other.createScript<BoxCollider2>();
            oc.width = 700;
            oc.height = 48;
            other.transform2().Position = new Vector2(505, 510) * Settings.TileSizeV;


            //var other2 = GameEngine.RootObject.createChild();
            //camera.createComponent<Jump>();
            camera.createScript<Player>();
            //other2.createComponent<Velocity>();
            //var collider = camera.createComponent<BoxCollider2>();
            //collider.width = 32;
            //collider.height = 48;
            //camera.createComponent<Rigidbody>();
            camera.transform2().Position = new Vector2(505, 500) * Settings.TileSizeV;

            Root.instance.RootObject.createScript<Terrain>();
