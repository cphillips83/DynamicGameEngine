...
namespace GameName1.BulletHell.Scripts
{
    public class BloomCamera : Camera
    {
        ...
        private void init()
        {
            bloomExtractEffect = Root.instance.resources.loadEffect("content/textures/bullethell/BloomExtract.mgfxo");
            bloomCombineEffect = Root.instance.resources.loadEffect("content/textures/bullethell/BloomCombine.mgfxo");
            gaussianBlurEffect = Root.instance.resources.loadEffect("content/textures/bullethell/GaussianBlur.mgfxo");
