...
namespace GameName1.BulletHell.Scripts
{
    public class Entity : Script, IComparable<Entity>
    {
        ...
        public int minX { get { return (int)gameObject.transform.DerivedPosition.X - ((int)size.X >> 2); } }
        public int maxX { get { return (int)gameObject.transform.DerivedPosition.X + ((int)size.X >> 2); } }
