...
namespace GameName1.PI
{
    ...
    public class Game : GameEngine
    {
        ...
        protected override void LoadContent()
        {
            ...
            Root.instance.RootObject.createScript<Player>();
            Root.instance.RootObject.createScript<HUD>();
            Root.instance.RootObject.createScript<Build>();

            Root.instance.RootObject.prefabPlanet();
            Root.instance.RootObject.createScript<DebugStats>();
            //Root.instance.RootObject.createScript<Planet>();
