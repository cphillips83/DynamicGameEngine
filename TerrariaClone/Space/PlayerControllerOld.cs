...
{
    public class PlayerControllerOld : Script
    {
        ...
        private void render()
        {
            ...
            Root.instance.graphics.DrawText(1, Root.instance.resources.findFont("content/fonts/arial.fnt"), 1f, _transform.DerivedPosition, velocityY.ToString(), Color.White);
        }
