...
namespace GameName1.SRPG
{
    ...
    public class Game : GameEngine
    {
        ...
        protected override void LoadContent()
        {
            ...
            var turnManager = Root.instance.RootObject.createScript<TurnManager>();
            //Root.instance.RootObject.createScript<Debug>();
            var player = Root.instance.RootObject.prefabPlayer();
            var camera = Root.instance.RootObject.prefabCamera();
            //camera.prefabCommandMenu();
            //camera.createScript<GUI>();
