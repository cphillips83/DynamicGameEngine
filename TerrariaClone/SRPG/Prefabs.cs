...
namespace GameName1.SRPG
{
    public static class Prefabs
    {
        public static GameObject prefabPlayer(this GameObject parent)
        {
            ...
            sprite.size = new Vector2(32, 32) * Game.WORLD_SCALE;
        ...
        public static GameObject prefabCommandMenu(this GameObject parent)
        {
            var go = parent.createChild("commandMenu");
            var menu = go.createScript<CommandMenu>();
            menu.fontName = "content/fonts/arial.fnt";
            go.transform.Position = new Vector2(-375, 150);
            return go;
        }
    }
}
