...
//            Real trace = matrix.M11 + matrix.M22 + matrix.M33;
...
//                result.x = ( matrix.M32 - matrix.M23 ) * root;
//                result.y = ( matrix.M13 - matrix.M31 ) * root;
