...
using Dynamic.GameEngine.Math.Collections;
//
//using Radian = System.Single;
//using Degree = System.Single;
using Dynamic.GameEngine.Utilities;
using OpenTK;
...
namespace Dynamic.GameEngine.Math
{
    public sealed class Utility
    {
        ...
        public static Real BoundingRadiusFromAABB(AxisAlignedBox3 aabb)
        {
            ...
            magnitude = magnitude.Ceiling(-max);
            magnitude = magnitude.Ceiling(min);
            magnitude = magnitude.Ceiling(-min);
        ...
        public static IntersectResult Intersects(Ray3 ray, Plane plane)
        {
            ...
            Real denom = Vector3.Dot(plane.Normal, ray.direction);
            ...
            else
            {
                ...
                Real nom = Vector3.Dot(plane.Normal, ray.Origin) + plane.D;
                Real t = -(nom / denom);
