...
namespace Dynamic.GameEngine.Math
{
	...
	public struct Plane
	{
		...
		public Vector3 ProjectVector( Vector3 point )
		{
			...
			xform.M11 = 1f - this.Normal.X * this.Normal.X;
			xform.M12 = -this.Normal.X * this.Normal.Y;
			xform.M13 = -this.Normal.X * this.Normal.Z;
			xform.M21 = -this.Normal.Y * this.Normal.X;
			xform.M22 = 1f - this.Normal.Y * this.Normal.Y;
			xform.M23 = -this.Normal.Y * this.Normal.Z;
			xform.M31 = -this.Normal.Z * this.Normal.X;
			xform.M32 = -this.Normal.Z * this.Normal.Y;
			xform.M33 = 1f - this.Normal.Z * this.Normal.Z;

            return point.Transform(xform);
		}
