...
namespace Dynamic.GameEngine.Utilities
{
	/// <summary>
	...
	internal static class ExceptionFactory
	{
        ...
        public static Exception CreateFatalException(string msg)
        {
            return new Exception(msg);
        }

        public static Exception CreateFatalException(string msg, params object[] args)
        {
